...
// riempiamo la riga con gli gadget
      ...
      <div class="card h-100 d-flex flex-column border-3 border-danger bg-black text-white">
        ...
        <div class="card-body d-flex flex-column justify-content-around">
          ...
          <div class="col d-flex flex-column justify-content-end ">
            <div class="d-flex flex-column flex-md-row justify-content-evenly mb-2">
               <p class="card-text">Brand:${gadget.brand}</p>
               <p class="card-text">${gadget.price}€</p>
            </div>
            <div class="d-flex justify-content-evenly">
              <a href="details.html?gadgetId=${gadget._id}" class="btn btn-success text-danger fw-bolder fs-4 border-danger border-3">Edit <i class="bi bi-pencil-fill"></i></a>
            </div>
          </div>
        </div>
      </div>
